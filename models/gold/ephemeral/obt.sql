{% set configs = [
    ...
    },
    {
        ...
        'columns' : "silver_hosts.HOST_SINCE, silver_hosts.HOST_NAME, silver_hosts.IS_SUPERHOST, silver_hosts.RESPONSE_RATE, silver_hosts.RESPONSE_RATE_QUALITY, silver_hosts.CREATED_AT AS HOST_CRATED_AT",
        'alias' : 'silver_hosts',
